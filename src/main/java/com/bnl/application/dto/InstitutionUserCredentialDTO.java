...
public class InstitutionUserCredentialDTO {
	...
	private List<InstitutionUserCredentialMasterDTO> institutionUserCredentialMaster; 
	
	public List<InstitutionUserCredentialMasterDTO> getInstitutionUserCredentialMaster() {
		return institutionUserCredentialMaster;
	}
	public void setInstitutionUserCredentialMaster(List<InstitutionUserCredentialMasterDTO> institutionUserCredentialMaster) {
